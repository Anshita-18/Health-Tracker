...
class Face_Register:
    def __init__(self):
        ...
        self.input_name1 = tk.Entry(self.frame_right_info)
        self.input_name1_char = ""
        self.input_name2 = tk.Entry(self.frame_right_info)
        self.input_name2_char = ""
        self.input_name3 = tk.Entry(self.frame_right_info)
        self.input_name3_char = ""
    ...
    #     self.input_name_char1 = self.input_name1.get()
    #     self.input_name_char2 = self.input_name2.get()
    #     self.input_name_char3 = self.input_name3.get()
    ...
    #     data = {
    #         'Roll Number': self.input_name_char,
    #         'Name': self.input_name_char1,
    #         'Class': self.input_name_char2,
    #         'Section': self.input_name_char3
    #     }
    ...
    #         fieldnames = ['Roll Number', 'Name', 'Class', 'Section']
    #         writer = csv.DictWriter(csvfile, fieldnames=fieldnames)

    #         if not file_exists:
    #             writer.writeheader()  # Write a header row if the file is empty
    ...
    def GUI_get_input_name(self):
        ...
        if self.check_duplicate_name():
            # Show error message and close the page
    ...
    def check_duplicate_name(self):
        ...
        # Read CSV file and check for duplicate name
        with open(csv_file_path, 'r') as csvfile:
            reader = csv.DictReader(csvfile)
            for row in reader:
                if row['Roll Number'] == self.input_name_char:
                    return True
        return False
    ...
    def GUI_info(self):
        ...
        tk.Label(self.frame_right_info,
                 font=self.font_step_title,
                 text="Enter the details : ").grid(row=7, column=0, columnspan=2, sticky=tk.W, padx=5, pady=20)

        tk.Label(self.frame_right_info, text="Roll number: ").grid(row=8, column=0, sticky=tk.W, padx=5, pady=0)
        self.input_name.grid(row=8, column=1, sticky=tk.W, padx=0, pady=2)

        tk.Label(self.frame_right_info, text="Name: ").grid(row=9, column=0, sticky=tk.W, padx=5, pady=0)
        self.input_name1.grid(row=9, column=1, sticky=tk.W, padx=0, pady=2)

        tk.Label(self.frame_right_info, text="Class: ").grid(row=10, column=0, sticky=tk.W, padx=5, pady=0)
        self.input_name2.grid(row=10, column=1, sticky=tk.W, padx=0, pady=2)

        tk.Label(self.frame_right_info, text="Section: ").grid(row=11, column=0, sticky=tk.W, padx=5, pady=0)
        self.input_name3.grid(row=11, column=1, sticky=tk.W, padx=0, pady=2)

        tk.Button(self.frame_right_info,
                  text='Submit',
                  command=self.GUI_get_input_name).grid(row=12, column=0, padx=2)

        # Step 3: Save current face in frame
        tk.Label(self.frame_right_info,
                 font=self.font_step_title,
                 text="Save face image").grid(row=13, column=0, columnspan=2, sticky=tk.W, padx=5, pady=20)

        tk.Button(self.frame_right_info,
                  text='Save current face',
                  command=self.save_current_face).grid(row=14, column=0, columnspan=3, sticky=tk.W)
